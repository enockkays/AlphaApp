package com.me.alpha.SegmentProgress;
...
public abstract class CountDownTimerWithPause {
     ...
     *                          is called
     * countDownInterval The interval in millis at which to execute
     *                          {@link :onTick(millisUntilFinished)} callbacks
     *  runAtStart        True if timer should start running, false if not
     */
